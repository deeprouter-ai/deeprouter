...
func SetupContextForToken(c *gin.Context, token *model.Token, parts ...string) error {
	...
	common.SetContextKey(c, constant.ContextKeyTokenSimplePurpose, token.SimplePurpose)
	common.SetContextKey(c, constant.ContextKeyTokenSimpleBrand, token.SimpleBrand)
	common.SetContextKey(c, constant.ContextKeyTokenSimplePriceTier, token.SimplePriceTier)
	if len(parts) > 1 {
