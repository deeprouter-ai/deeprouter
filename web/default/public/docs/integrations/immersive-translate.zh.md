...
api_protocol: OpenAI
base_url: "https://api.deeprouter.co/v1/chat/completions"
base_url_warning: "This tool wants the FULL endpoint, not just the base."
...
guide: "https://deeprouter.co/resources/immersive-translate"
```
